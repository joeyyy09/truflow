...
class Ui_StartWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow) -> None:
        MainWindow.setWindowTitle(QCoreApplication.translate("StartWindow", "Welcome To Truflow", None))
        self.label.setText(QCoreApplication.translate("StartWindow", "Truflow", None))
